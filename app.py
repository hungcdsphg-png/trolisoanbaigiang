...
# --- 1. CẤU HÌNH TRANG ---
st.set_page_config(page_title="Trợ lý tạo Kế hoạch bài dạy NLS", page_icon="📘", layout="centered")
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Đức Hùng - Trường PTDTBT Tiểu học Nấm Dẩn - ĐT: 0364196097</div>", unsafe_allow_html=True)
